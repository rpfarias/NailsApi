...
import com.nail.service.ProductService;
...
@Api(value = "Product Controller")// descrevendo essa classe no Swagger
@RestController
...
public class ProductController {
    ...
    @GetMapping
    @ApiOperation("Find All products")//descrevendo o endpoint
